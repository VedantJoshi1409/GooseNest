    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-8 py-16 text-center">
        ...
        <p className="text-xl text-[var(--goose-ink)] mb-8">
          Coming soon - Plan your terms and courses
        </p>
        <Link
          href="/"
          className="inline-block px-8 py-3 border border-[var(--goose-ink)] text-[var(--goose-ink)] rounded hover:bg-[var(--goose-cream)] hover:text-[var(--goose-cream)] transition-colors"
        >
          ← Back to home
        </Link>
      </main>
